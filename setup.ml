...
(* OASIS_START *)
(* DO NOT EDIT (digest: 65c322f0d755453e4354ad450e25d880) *)
(*
...
let setup_t =
  {
     ...
     doc = [("api-camlm", OCamlbuildDocPlugin.doc_build "src/")];
     ...
     clean_doc = [("api-camlm", OCamlbuildDocPlugin.doc_clean "src/")];
     distclean = [];
     distclean_test =
       [
          ("main",
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Ã¼±f¨9\147Ý\004\003\128L%ñ\153è";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
