...
(* OASIS_START *)
(* DO NOT EDIT (digest: f2a19fee08c42466fbee47785e264a17) *)
(*
...
let setup_t =
  {
     ...
     doc = [("api-camlm", OCamlbuildDocPlugin.doc_build "src/compiler/")];
     ...
     clean_doc =
       [("api-camlm", OCamlbuildDocPlugin.doc_clean "src/compiler/")];
     distclean = [];
     distclean_test =
       [
          ("main",
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "camlm"];
                      bs_build_tools =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "®e\031(\022\127�Bܠ*45 \006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
